...
public class Config {
    ...
    public static Config parse(JSONObject data) throws JSONException {
        ...
        if (data.has("loginTabs")) {
            ...
            List<String> loginTab = Util.toStringList(loginTabList);
            if (loginTab.contains("phone-code")) {
                if (data.has("verifyCodeTabConfig")) {
                    ...
                    List<String> enabledLoginMethodsList = Util.toStringList(enabledLoginMethods);
        ...
        if (data.has("registerTabs")) {
            ...
            config.setRegisterTabList(Util.toStringList(registerTabList));
        ...
        if (data.has("passwordTabConfig")) {
            ...
            config.setEnabledLoginMethods(Util.toStringList(enabledLoginMethods));
        }
        ...
        if (data.has("complateFiledsPlace")) {
            config.setCompleteFieldsPlace(Util.toStringList(data.getJSONArray("complateFiledsPlace")));
        }
        ...
        if (data.has("redirectUris")) {
            config.setRedirectUris(Util.toStringList(data.getJSONArray("redirectUris")));
        }
