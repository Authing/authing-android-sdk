...
public class TestCase implements Parcelable {
    ...
    public String getTestApiName() {
        return testApiName;
    }

    public void setTestApiName(String testApiName) {
        this.testApiName = testApiName;
    }
